...
| ALG04 | mathontospeak_semantic | R- i- i- i- i- i- i- i- i- i- i- i- i- i- i- i- | 0.979 | 0.000 | ok |
| CALC01 | mathontospeak_semantic | R-kind CALC01. Equation limb underscore x-right-pointing arrow 0-6, x-equals ... | 0.147 | 0.833 | ok |
| CALC02 | mathontospeak_semantic | Archive CalCO2, equation d dxx karat 3 equals 3x squared. Matched concepts, d... | 0.128 | 1.000 | ok |
| CALC03 | mathontospeak_semantic | Archive CalCO3, equation underscore zero to the power of 1x squared, matched ... | 0.109 | 1.000 | ok |
| LIN01 | mathontospeak_semantic | R kai vali n 0 1, equation u plus v equals w, matched concepts, variable, add... | 0.200 | 1.000 | ok |
